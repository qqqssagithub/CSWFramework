...
@interface QSAKitPromptView ()

@end

@implementation QSAKitPromptView
...
+ (instancetype)sharedInstance {
    static QSAKitPromptView *sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[QSAKitPromptView alloc] initWithFrame:QSAKit_SCREEN_RECT];
...
+ (void)show {
    QSAKitPromptView *view = [QSAKitPromptView sharedInstance];
...
+ (void)showWithWidth:(CGFloat)width blurEffectStyle:(BlurEffectStyle)blurEffectStyle activityIndicatorViewStyle:(ActivityIndicatorViewStyle)activityIndicatorViewStyle message:(NSString *)message messageFont:(UIFont *)font backgroundTransparency:(CGFloat)backgroundTransparency {
    [[QSAKitPromptView sharedInstance] showWithWidth:width blurEffectStyle:blurEffectStyle activityIndicatorViewStyle:activityIndicatorViewStyle message:message messageFont:font backgroundTransparency:backgroundTransparency];
}
...
+ (void)disappear {
    [[QSAKitPromptView sharedInstance] disappear];
}
